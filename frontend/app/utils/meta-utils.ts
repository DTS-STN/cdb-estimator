...
export function mergeMeta<TMetaArgs extends GetAnnotations<any>['MetaArgs'], TMetaDescriptors extends MetaDescriptor[]>(
  leafMetaFn: (args: TMetaArgs) => TMetaDescriptors,
): (args: TMetaArgs) => TMetaDescriptors {
  return (args) => {
